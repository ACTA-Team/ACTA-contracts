...
- Issuance Contract: `CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM`
...
Example (testnet):
`soroban contract invoke --id CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM --network testnet --source acta_sc_source -- initialize --admin G...ADMIN --issuer_did did:pkh:stellar:testnet:G...ADMIN`
...
Example (testnet):
`soroban contract invoke --id CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM --network testnet --source acta_sc_source -- issue --owner G...OWNER --vc_id "vc-123" --vc_data "<encrypted_payload>" --vault_contract CD7AN2XKCQLFNENL6YUUNZ6FBAL63N5J5X7AEGLRYSG6YBS6V35OSJCH`
...
Example (testnet):
`soroban contract invoke --id CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM --network testnet -- verify --vc_id vc-123`
...
Example (testnet):
`soroban contract invoke --id CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM --network testnet --source acta_sc_source -- revoke --vc_id vc-123 --date 2024-10-15T12:00:00Z`
...
Example (testnet):
`soroban contract invoke --id CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM --network testnet --source acta_sc_source -- migrate`
...
Example (testnet):
`soroban contract invoke --id CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM --network testnet --source acta_sc_source -- set_admin --new_admin G...NEWADMIN`
...
Example (testnet):
`soroban contract invoke --id CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM --network testnet --source acta_sc_source -- upgrade --new_wasm_hash a7a34e34b16d6ad3d4876f58737dfcbbaa8b5bb21abe17a3da022d181e4da3917`
...
Example (testnet):
`soroban contract invoke --id CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM --network testnet -- version`
...
- Manage IDs in configuration (e.g., `.env`):
  - `ISSUANCE_CONTRACT_ID=CC73D36JSGNJ4SFJGQGGHENNO4W7ZQX3ZRQ4ZUW65VVS5BUDZWLOVEXM`
